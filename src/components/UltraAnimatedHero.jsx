...
export default function UltraAnimatedHero({
  ...
  images = [
    { src: "dallas- Makeolix consulting.webp" },
    { src: "houston- Makeolix consulting.webp" },
    { src: "jacksonville- Makeolix consulting.webp" },
    { src: "chicago- Makeolix consulting.webp" },
    { src: "boston2- Makeolix consulting.webp" },
    { src: "miami- Makeolix consulting.webp" }, 
    { src: "philadelphia- Makeolix consulting.webp" },
    { src: "phoenix- Makeolix consulting.webp" },
    { src: "san antanio- Makeolix consulting.webp" },
    { src: "seattle- Makeolix consulting.webp" },
    { src: "indianapolis- Makeolix consulting.webp" },
  ],
}) {
